        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehiclePlate = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalValue = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Name = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Document = table.Column<string>(type: "TEXT", maxLength: 18, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestaurantComment = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    CourierRating = table.Column<int>(type: "INTEGER", nullable: true),
                    CourierComment = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
